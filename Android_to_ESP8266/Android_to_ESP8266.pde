...
void setup() 
{
      ...
      hs1 = new HScrollbar(0, 200, width, 140, 16, color(255,0,0,255));
      hs2 = new HScrollbar(0, 500, width, 140, 16, color(0,255,0,255));
      hs3 = new HScrollbar(0, 800, width, 140, 16, color(0,0,255,255));
     //////////////////
     
     //////////////////
     on_button = new Button("SEND", width /2, height - height /3, 400, 120);
     //////////////////
}
